                ...
                <div class="container">
                    <div class="col-md-12">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#"><img src="Medilab/img/logo.png" class="img-responsive"
                ...
                <div class="row">
                    <div class="banner-info">
                        <div class="banner-logo text-center">
                            <img src="Medilab/img/logo.png" class="img-responsive">
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="thumbnail">
                        <img src="Medilab/img/doctor1.jpg" alt="..." class="team-img">
                        <div class="caption">
                            <h3>Jessica Wally</h3>
                            <p>Doctor</p>
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="thumbnail">
                        <img src="Medilab/img/doctor2.jpg" alt="..." class="team-img">
                        <div class="caption">
                            <h3>Iai Donas</h3>
                            <p>Doctor</p>
                            <ul class="list-inline">
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="thumbnail">
                        <img src="Medilab/img/doctor3.jpg" alt="..." class="team-img">
                        <div class="caption">
                            <h3>Amanda Denyl</h3>
                            <p>Doctor</p>
                            <ul class="list-inline">
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="thumbnail">
                        <img src="Medilab/img/doctor4.jpg" alt="..." class="team-img">
                        <div class="caption">
                            <h3>Jason Davis</h3>
                            <p>Doctor</p>
                            <ul class="list-inline">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="testi-info">
                        <!-- User Image -->
                        <a href="#"><img src="Medilab/img/thumb.png" alt="" class="img-responsive"></a>
                        <!-- User Name -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    <h3>Contact Info</h3>
                    <div class="space"></div>
                    <p><i class="fa fa-map-marker fa-fw pull-left fa-2x"></i>321 Awesome Street<br> New York, NY 17022
                    </p>
                    <div class="space"></div>
